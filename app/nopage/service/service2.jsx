...
const ServicesSection = () => {
  ...
  const services = [
    ...
    {
      id: 18,
      title: "Backyard & Patio Renovation Experts",
    ...
    <section className="w-full bg-blue-50 py-8 lg:py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-5 lg:p-6 text-white z-10">
                    ...
                    >
                      ...
                      <motion.button
                        className="bg-white text-gray-900 font-medium px-4 py-2  flex items-center gap-1 text-sm lg:text-base"
        ...
        >
          ...
          <motion.button
            className="bg-b1 text-white font-medium px-8 py-3  flex items-center gap-2 mx-auto text-base lg:text-lg shadow-lg  transition-colors"
            whileHover={{ 
              scale: 1.03,
